...
function Starred(){
  ...
  const [backgroundimage,setbackgroundimage]=useState('https://upload.wikimedia.org/wikipedia/commons/3/35/Neckertal_20150527-6384.jpg');
...
.then((todos) => settodoslist(todos))
  ...
  const getTodos = ()=>{
    ...
    return todoslist.filter((todo)=>todo.starred);
  }
  const edititem = (id)=>{
