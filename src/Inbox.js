...
function Inbox(){
  ...
  const [backgroundimage,setbackgroundimage]=useState('https://www.slrlounge.com/wp-content/uploads/2020/06/best-landscape-photographers-to-follow-in-2020.jpg');
  ...
  //   const notification = new Notification("Message From Vishnu TODO app",{
  //     body:"Hey User, You Have incompleted Todos",
  //     icon:"https://yt3.ggpht.com/yti/APfAmoGp6OZREmqtHTTCPzniA5uqUKOtJngoqaLtQ5-IRA=s88-c-k-c0x00ffffff-no-rj-mo"
  //   });
  //   notification.onclick = (e) => {
  //     window.location.href = "https://microsoft-todo-clone-vishnu.herokuapp.com/"
  //   }
  // }
...
// },[todoslist,credentials]);
  ...
  const edititem = (id)=>{
    ...
    // setInput1(newTodoList2[index].todo);
    // setinputdate1(newTodoList2[index].date);
    // var ttt = newTodoList2[index].time;
    // // ttt.slice(0, -1);
    // // ttt.slice(0, -1);
    // // ttt.slice(0, -1);
    // setinputtime1(ttt);
  ...
  const handleSubmit1 = (e) =>{
    ...
    // newTodoList3[editableindex].todo = input1;
    // newTodoList3[editableindex].date = inputdate1;
    ...
    // }
    //
    // newTodoList3[editableindex].time = time1;
...
//
//   var dib = todoslist;
//   // const dib = todoslist.find((todo) => todo.date === dateinput1);
//   // console.log(todoItem1);
//   // settodoslist(dib);
//
//   if(!dateinput1){
...
//   }else{
//     dib.map((todo)=>{
//       if(dateinput1 === todo.date){
//         console.log('found');
//       }else{
//         // dib.splice(index,1);
//         dib = dib.filter(function(ele){
//             return ele._id !== todo._id;
//         });
//         settodoslist(dib);
//
//   }
...
//   }
  ...
  return(<Container style={{backgroundColor:backgroundimage,backgroundImage:`url(${backgroundimage})`,backgroundRepeat:'no-repeat',backgroundSize:'cover'}}>
    ...
    <div className="content1">
      <h3> INBOX </h3>
      <input type="text" onChange={(e)=>{setDateInput1(e.target.value)}} name="datitem" placeholder = "Enter Date to Search Todo" value={dateinput1}/>
      <div>
